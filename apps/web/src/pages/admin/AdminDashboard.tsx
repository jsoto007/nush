...
import { type Restaurant, type ApiResponse } from "@repo/shared";
        ...
        <AdminLayout>
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-stone-500 font-medium">Manage your restaurants and operations.</p>
                </div>
                <button className="flex items-center gap-2 rounded-2xl bg-stone-900 px-6 py-3 text-sm font-bold text-white transition hover:bg-stone-800">
                    <Plus size={18} />
                    New Restaurant
                </button>
            </div>
            ...
            {restaurants.length === 0 && (
                <div className="flex flex-col items-center justify-center h-[40vh] border-2 border-dashed border-stone-200 rounded-3xl">
                    ...
                    <button className="mt-4 text-sm font-black text-stone-900 underline">Create your first restaurant</button>
                </div>
            )}
        </AdminLayout>
    );
