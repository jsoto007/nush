...
def upgrade():
    ...
    op.create_foreign_key(
        'fk_addresses_restaurant_id_restaurants',
        'addresses',
        'restaurants',
        ['restaurant_id'],
        ['id'],
    ...
    op.create_foreign_key(
        'fk_restaurants_address_id_addresses',
        'restaurants',
        'addresses',
        ['address_id'],
        ['id'],
    ...
    op.create_foreign_key(
        'fk_restaurants_stripe_account_id_stripe_accounts',
        'restaurants',
        'stripe_accounts',
        ['stripe_account_id'],
        ['id'],
    ...
    op.create_foreign_key(
        'fk_stripe_accounts_restaurant_id_restaurants',
        'stripe_accounts',
        'restaurants',
        ['restaurant_id'],
        ['id'],
    ...
    op.create_foreign_key(
        'fk_stripe_accounts_courier_id_users',
        'stripe_accounts',
        'users',
        ['courier_id'],
        ['id'],
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_stripe_accounts_courier_id_users', 'stripe_accounts', type_='foreignkey')
    op.drop_constraint('fk_stripe_accounts_restaurant_id_restaurants', 'stripe_accounts', type_='foreignkey')
    op.drop_constraint('fk_restaurants_stripe_account_id_stripe_accounts', 'restaurants', type_='foreignkey')
    op.drop_constraint('fk_restaurants_address_id_addresses', 'restaurants', type_='foreignkey')
    op.drop_constraint('fk_restaurants_owner_id_users', 'restaurants', type_='foreignkey')
    op.drop_constraint('fk_addresses_restaurant_id_restaurants', 'addresses', type_='foreignkey')
